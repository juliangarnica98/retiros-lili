    ...
    <div class="navegacion">
        <nav class="navbar navbar-light background-barnav2 fixed-top pt-2 pb-2">
            <div class="container-fluid">
                ...
                <div class="d-flex">
                    <a class="navbar-brand pr-4 text-light" href="#quienes_somos">¿Quienes somos?</a>
                    <a class="navbar-brand pr-4 text-light" href="#ofertas">Ofertas</a>
                    <a class="navbar-brand pr-4 text-light" href="#porque">¿Por qué trabajar con nosotros?</a>
                    <a class="navbar-brand pr-4 text-light" href="#contactanos">Contactanos</a>
                </div>
            </div>
        </nav>
    </div>
    ...
    <div class="quienes_somos" id="quienes_somos">
        <div class="container">
            <div class="row pb-4">
                ...
                <div class="col-md-7 text-light pt-3">
                    ...
                    <p class="pt-5 h4 text-center">Somos una marca JOVEN, CREATIVA, FRESCA y DIVERTIDA, pensada en mujeres con estas mismas características. El color, la comodidad y la tecnología son nuestras principales cualidades por las que nuestras consumidoras nos refieren...</p>
                </div>
     ...
     <div class="ofertas pb-5" id="ofertas" style="background-color: #212529">
            ...
            <div class="d-flex justify-content-center">
                <a class="btn btn-light btn-block mt-5 col-4" style="border-radius: 30px; border-color: #e85199; color: #e85199" href="">Información</a>
            </div> 
    </div>
                        ...
                        <form action="">
                            ...
                            <div class="mb-3">
                              ...
                              <div class="d-flex justify-content-center pt-4">
                                <button class="btn btn-light col-4" style="border-radius: 30px; border-color: #e85199; color: #e85199">Enviar</button>
                              </div>
        ...
        <footer class="text-center text-white" style="background-color: #212529" >
            ...
            <div class="container pt-4">
              ...
              <section class="mb-4">
                ...
                <!-- Twitter -->
                <a class="btn btn-link btn-floating btn-lg text-light m-1"  href="#!" role="button"  data-mdb-ripple-color="dark"><i class="fab fa-twitter"></i></a>
